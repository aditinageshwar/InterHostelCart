  ...
  return (
    <nav className="bg-white">
      <div className="mx-auto ">
        ...
        <div className="  flex justify-between items-center  px-20 py-4 border-t border-b border-gray-200">
          <div className="text-2xl font-bold text-rose-400">InterHostel Cart</div>
            ...
            <div className="flex items-center space-x-4">
              ...
              {showMenu && (
              <div className="fixed top-16 right-5 w- mr-5 rounded-xl z-30 bg-gray-200 shadow-md p-6">
              <ul>
               <li>
                <NavLink to="/profile"
        ...
        {/* Bottom navbar */}
        <div className="flex py-2 bg-cyan-700 text-white px-20">
          <div className="bg-rose-400 text-white px-4 py-2 font-bold rounded-full">
            CATEGORIES
          </div>
